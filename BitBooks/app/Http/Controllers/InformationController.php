...
//        return redirect('/timelines.changeProfile')->with(['userInfo' => $userInfo]);
    ...
    public function FriendTimeline($id)
    {
        ...
        return view('timelines.friend_timeline')->with(['friend' => $userInfo,'myallstatus' => $status]);
    }
    ...
    public function FriendTimelineAbout($id)
    {
        ...
        return view('timelines.friend_timeline_about')->with(['friend' => $friendTimeline]);
    }


    public function FriendTimelineAblbum($id)
    {
        $userInfo =  DB::table('informations')->where('u_id', $id)->get();

        return view('/timelines.friend_timeline_album')->with(['friend' => $userInfo]);
    }
     public function FriendTimelineFriends($id)
        {
            $userInfo =  DB::table('informations')->where('u_id', $id)->get();

            return view('/timelines.friend_timeline_friends')->with(['friend' => $userInfo]);
        }
    ...
    public function MyFriendTimeline($id)
    {
        ...
        return view('timelines.myfriend_timeline')->with(['friend' => $userInfo,'myallstatus' => $status]);
    }
    ...
    public function MyFriendTimelineAbout($id)
    {
        ...
        return view('timelines.myfriend_timeline_about')->with(['friend' => $friendTimeline]);
    }

    public function MyFriendTimelineAblbum($id)
    {
        $userInfo =  DB::table('informations')->where('u_id', $id)->get();

        return view('/timelines.myfriend_timeline_album')->with(['friend' => $userInfo]);
    }
     public function MyFriendTimelineFriends($id)
        {
            $userInfo =  DB::table('informations')->where('u_id', $id)->get();

            return view('/timelines.myfriend_timeline_friends')->with(['friend' => $userInfo]);
        }
    ...
    public function confirmFriendTimeline($id)
    {
        $userInfo =  DB::table('informations')->where('u_id', $id)->get();
        $status =  DB::table('statuses')->where('u_id', $id)->get();
        return view('/timelines.confirm_friend_timeline')->with(['friend' => $userInfo,'myallstatus' => $status]);
    }
