                ...
                <div class="col-md-9">
                    ...
                    <ul class="follow-me list-inline">
                        ...
                        <div class="col-md-3 col-sm-3" style="width: 150px; margin-top: 10px;">
                            <a href="{{ url('/confirmFriend/'.$userinfo->id.'/'.$userinfo->u_name) }}" class="pull-right btn btn-success btn-sm">
                                Confirm
                            </a>
                            <a href="{{ url('/Reject/'.$userinfo->id) }}" class="pull-right btn btn-danger btn-sm">
                                Reject
                            </a>
                        </div>
                    </ul>
